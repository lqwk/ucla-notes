...
* Multiple threads can run in a process – They all share the same code and data space
  – They all have access to the same resources – This makes the cheaper to create and run
...
* Or perhaps multiple processes? – With one thread each?
